    ...
    <div className="w-full max-w-[1080px] mx-auto min-h-screen bg-[#F6EDFF]/50 dark:bg-slate-950 transition-colors duration-300 overflow-hidden flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-start pt-4 px-6 gap-8">
        ...
        <div className="flex gap-4 w-full max-w-xs">
          <button onClick={handleCopy} className="flex-1 py-3 px-4 rounded-xl bg-white dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 flex items-center justify-center gap-2 hover:border-[#D364DB] active:scale-95 transition-all shadow-sm">
